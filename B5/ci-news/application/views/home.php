...
<body>
<div class="form">
    <form id="form-1" method="post" action="<?php echo site_url('UserController/create') ?>">
        <h2>Your information</h2>
        <div class="form-group">
            <p type="Name:">
                <input type="text" id="fullname" name="fullname" placeholder="Write your name here.."></input>
            </p>
            <span class="form-message"></span>
        </div>
        <div class="form-group">
            <p type="Email:">
                <input type="text" id="email" name="email" placeholder="Write your email here.."></input>
            </p>
            <span class="form-message"></span>
        </div>
        <div class="form-group">
